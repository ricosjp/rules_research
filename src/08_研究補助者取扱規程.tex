...
\article{目的}
この規程は、株式会社ＲＩＣＯＳ（以下「当会社」という。）このにおける、特定の研究課題等の遂行に必要な技能・技術面での支援を確保することにより、研究課題等を効果的にするとともに、学術研究を支えるための研究支援体制の強化を図ることを目的として、研究補助者の雇用等に必要な事項を定めるものとする。
...
\term この規程に定めるもののほか、研究補助者の給与、通勤手当、勤務時間、およびその他就業等に関しては、当会社「就業規則」に基づき、それぞれの雇用契約において定める。
